...
/*
Мы определили следующие методы:
    computeQueryParams — для построения параметров запроса;
    request — для создания и обработки запроса;
    onError — для обработки ошибок;
    get — для создания GET-запросов;
    post — для создания POST запросов;
    put — для создания PUT-запросов;
    delete — для создания DELETE-запросов.
*/