export class HttpClient {
 ...
 /*
  ...
  Это поможет предотвратить ситуации, когда запрос my-domain.com/tasks/create
  выглядит как my-damain.com/taskscreate
 */
  checkPath(path) {
    if (!path.startsWith('/')) {
  ...
  async get (path, options) {
    this.checkPath(path)
    return this.httpProvider.het(path, this.buildRequest(options))
  }
